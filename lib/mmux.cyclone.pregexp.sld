...
;;;Abstract
;;;
;;;	This library is  based upon "pregexp" by Dorai  Sitaram.  It was modified to  work with R6RS
;;;	Scheme implementations and to fit into the Nausicaa distribution.  The it was modified again
;;;	to work with Cyclone Scheme.
;;;
;;;	The original code is available at (URL last verified May 16, 2020):
;;;
;;;		<https://github.com/ds26gte/pregexp>
;;;
;;;Copyright (c) 1999-2015 Dorai Sitaram. All rights reserved.
...
(define-library (mmux.cyclone.pregexp)
  (export
    pregexp
    ...
    ;; version functions
    mmux-cyclone-pregexp-package-major-version
